    ...
    <div class="col-lg-12">
        <div class="card bg-warning">
            ...
            <div class="row justify-content-center pt-4">
                <label for="" class="mt-2 h6">Month</label>
                <div class="col-sm-3">
            ...
            <hr>
            <div class="col-md-12">
                <table class="table table-dark table-bordered table-hover" id='report-list'>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php
                            $i = 1;
                            $total = 0;
                            $totalExpense = 0; // initialize total expense to 0
                            ...
                            if($sales->num_rows > 0):
                                while($row = $sales->fetch_array()):
                                    $total += $row['total_amount'] - $row['expense'];
                                    $totalExpense += $row['expense']; // add expense for each sale
                            ?>
                                    <tr>
                                    ...
                                    <td>
                                        <p class="text-right"> <b><?php echo number_format($row['expense'],2) ?></b></p>
                                    </td>
                                </tr>
                                    <?php 
                                        endwhile;
