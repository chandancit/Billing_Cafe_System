...
<div class="container-fluid">
	<p class="text-center"><b><?php echo $amount_tendered > 0 ? "Radha Rasoi Family Restaurant": "Bill" ?></b></p>
	<hr>
	<div class="flex">
    <div class="w-100">
			<?php if (!empty($order_number)): ?>
                <div>Table No: <?php echo $order_number; ?></div>
            <?php endif; ?>
	...
	<hr>
	<p class="text-center"><b>Powered by TechOrgans</b></p>
    <hr>
</div>